...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:300px;" id="mySidebar">
  ...
  <div class="w3-large" style="font-weight:bold">
    <a href="edit_profile_user.php" class="w3-bar-item w3-button" style="text-decoration: none;"><font face="FC Lamoon">ยินดีต้อนรับ คุณ <?php echo $Result["fname"];?></font></a>
...
<form name="form1" method="post" action="save_checkout.php">
  <table width="50%" border="0" align="center">
    ...
    <input type="hidden" name="userid" value="<?php echo $userid;?>">
      <td width="71">ชื่อ</td>
      <td width="217">: <input type="text" name="txtName" id="txtName" value="<?php echo $Result["fname"];?>"></td>
    </tr>
    <tr>
      <td>ระบุลักษณะสถานที่อย่างชัดเจน</td>
      <td>: <input type="text" name="txtAddress" id="txtAddress" value="<?php echo $Result["description"];?>"></td>
    </tr>
    <tr>
      <td>เบอร์โทรศัพท์</td>
      <td>: <input type="text" name="txtTel" id="txtTel" value="<?php echo $Result["tel"];?>"></td>
    </tr>
    <tr>
      <td>อีเมลล์</td>
      <td>: <input type="text" name="txtEmail" id="txtEmail" value="<?php echo $Result["email"];?>"></td>
    </tr>
    <tr>
    <td>สถานะอาหาร</td>
    <td>: <select name="status_food" required id="status_food">
            <option selected ="true" value="รอการยืนยันการสั่งอาหาร">รอการยืนยันการสั่งอาหาร</option>
        </select></td>
	  	
    </tr>
<input type="hidden" name="userid" id="userid" value="<?php echo $Result["userid"];?>">
      <tr><td colspan="2" align="center"> <input type="submit" name="Submit" value="สั่งซื้อ"></td>
    </tr>
  </table>
