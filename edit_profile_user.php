...
<div class="w3-main" style="margin-left:300px">
  ...
  error_reporting( error_reporting() & ~E_NOTICE );
    ...
    extract($objResult);
  ?>
  <form name="user" method="POST" action="save_editprofile_user.php" id="user">
  ...
  <table border="0" style="width:90%" align="center">
    ...
    <input type="hidden" name="userid" value="<?php echo $userid;?>">
      ...
      <tr>
        <td>บ้านเลขที่</td>
        <td><div style="color:red"> <font face="FC Lamoon">*ไม่มีให้ใส่เครื่องหมาย - </font><br></div>
        : <input name="house_no" type="text" required id="house_no" value="<?=$house_no;?>">
              </td>
      </tr>
      <tr>
        <td>หมู่บ้าน</td>
        <td>: <input name="village" type="text" required id="village" value="<?=$village;?>">
        </td>
      </tr>
      <tr>
        <td>หมู่ที่</td>
