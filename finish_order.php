...
<div class="w3-main" style="margin-left:300px">
  ...
  <!-- Top header -->
  <header class="w3-container w3-xlarge"><p class="w3-right">  
...
?>
<div align="center"> <h1><font face="FC Lamoon">สั่งอาหารของคุณแล้ว </font> </h1></div>
<br><br>
<div align="center"><a href="status_food_user.php?ID=<?php echo $objResult["userid"];?>" style="text-decoration: none; color:red;" ><font face="FC Lamoon">ดูสถานะอาหาร</font> </a>
 </div>
